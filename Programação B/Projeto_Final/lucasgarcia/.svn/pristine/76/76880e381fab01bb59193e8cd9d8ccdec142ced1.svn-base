...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            ...
            String query = "SELECT * FROM lucasgarcia_pessoas where Nome ='" + nome + "'";
...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            stmt.execute("delete from lucasgarcia_pessoas where Nome = '" + txt_nome.getText() + "' our id = '" + txt_id.getText() + "'");
            conn.close();
