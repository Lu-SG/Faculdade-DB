 ...
 */
public class Pessoas_Interface extends javax.swing.JFrame {

    /**
     * Creates new form Pessoas_Interface
     */
    public Pessoas_Interface() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txt_TipoPessoa.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txt_TipoPessoaActionPerformed(evt);
            }
        });
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_cep, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_endereco, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_email, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(jLabel7, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_celular, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addComponent(txt_TipoPessoa, javax.swing.GroupLayout.PREFERRED_SIZE, 90, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            ...
            String query = "SELECT * FROM lucasgarcia_pessoas where Id='" + Id + "'";
            ...
            while (rs.next()) {
                ...
                txt_idade.setText(rs.getString("Idade"));
                txt_TipoPessoa.setText(rs.getString("TipoPessoa"));
...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            ...
            stmt.execute("UPDATE lucasgarcia_pessoas SET Nome = '" + txt_nome.getText() + "', Cpf = '" + txt_cpf.getText() + "', Rg = '" + txt_Rg.getText() + "', Cep = '" + txt_cep.getText() + "', Endereco = '" + txt_endereco.getText() + "', Data = '" + txt_data.getText() + "', Email = '" + txt_email.getText() + "', Celular = '" + txt_celular.getText() + "', Idade = '" + txt_idade.getText() + "', TipoPessoa = '" + txt_TipoPessoa.getText() + "'  WHERE Id = '" + Id + "'");
            conn.close();
    ...
    private void button_deletarActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        try {
...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            stmt.execute("delete from lucasgarcia_pessoas where id = '" + txt_id.getText() + "'");
            conn.close();
    ...
    private void button_salvarActionPerformed(java.awt.event.ActionEvent evt) {
        // TODO add your handling code here:
        try {
...
//ResultSet rs = stmt.executeQuery( "SELECT nome FROM cliente WHERE color = 'blue'" );
            ...
            stmt.execute("INSERT INTO lucasgarcia_pessoas(Nome,Cpf,Rg,Cep,Endereco,Data,Email,Celular,Idade,TipoPessoa) VALUES('" + txt_nome.getText() + "','" + txt_cpf.getText() + "','" + txt_Rg.getText() + "','" + txt_cep.getText() + "', '" + txt_endereco.getText() + "', '" + txt_data.getText() + "','" + txt_email.getText() + "','" + txt_celular.getText() + "', '" + txt_idade.getText() + "', '" + txt_TipoPessoa.getText() + "')");
    ...
    private void txt_TipoPessoaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txt_TipoPessoaActionPerformed
        // TODO add your handling code here:
        try {
    ...
    }//GEN-LAST:event_txt_TipoPessoaActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Pessoas_Interface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Pessoas_Interface().setVisible(true);
