...
public class App {
    ...
    public static void main(String Args[]) {
        ...
        Pessoas p = new Pessoas(Login, Senha);
        ...
        String Endereco = JOptionPane.showInputDialog(null, "Informe Endereço");
        ...
        p.Cadastrar(Nome, Cpf, Rg, Cep, Endereco, Data, Email, Celular, Idade, TipoPessoa);
        p.Ler();
